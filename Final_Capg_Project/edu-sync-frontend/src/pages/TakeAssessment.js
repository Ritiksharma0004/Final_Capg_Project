...
//            // Save result to the result table
//            try {
//                await api.post('/Results', {
//                    assessmentId,
//                    userId: username,  // ideally user ID, here username for example
...
//    const username = 'Ritik Sharma'; // You can replace with actual username or id from your auth
//    const userId = 'user-unique-id-placeholder'; // Replace with actual userId from auth/session
...
const TakeAssessment = () => {
    ...
    const userId = user?.id || 'user-unique-id-placeholder';
    ...
    const handleSubmit = async () => {
        ...
        setTimeout(async () => {
            ...
            const resultData = {
                assessmentId: assessment.assessmentId, // use actual ID
                userId: user?.id,                      // should be valid user ID
                score: calculatedScore,
                attemptDate: new Date().toISOString(),
            };
